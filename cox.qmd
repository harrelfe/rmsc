...
```{r km-age-sex,w=4.5,h=3.5,cap='Kaplan--Meier log $\\Lambda$ estimates by sex and deciles of age, with $0.95$ confidence limits.  Solid line is for males, dashed line for females.',scap='Kaplan--Meier log $\\Lambda$ estimates by sex and deciles of age'}
...
```{r spline-age-sex-noia,w=4.5,h=3.5,cap='Cox PH model stratified on sex, using spline function for age, no interaction. 0.95 confidence limits also shown.  Solid line is for males, dashed line is for females.',scap='Cox PH model stratified on sex, using spline function for age',results='asis'}
...
```{r spline-age-sex-ia,w=4.5,h=3.5,cap='Cox PH model stratified on sex, with interaction between age spline and sex. 0.95 confidence limits are also shown.  Solid line is for males, dashed line for females.',scap='Cox PH model stratified on sex,with interaction between age spline and sex',results='asis'}
...
```{r spline-age-sex-ia-nomogram,w=6,h=5.75,results='asis',cap='Nomogram from a fitted stratified Cox model that allowed for interaction between age and sex, and nonlinearity in age.  The axis for median survival time is truncated on the left where the median is beyond the last follow-up time.',scap='Nomogram for stratified Cox model'}
