...
* cumulative probability models (often called _cumulative link models_ despite the fact that cumulative probabilities and not cumulative links are being computed) which are semiparametric models from a wider class of families than the logistic
...
### Checking Assumptions of OLS and Other Models {#sec-cony-checkass}
...
* Quantile regression [@koe05qua; @koe78reg] is a
...
using a full marginal likelihood of the ranks of $Y$ [@kal73mar].
