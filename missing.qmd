...
* @cha22mul have developed the most promising approach to obtaining approximate LRT (likelihood ratio tests) in the presence of missing data
...
h
processMI(h, which='anova')  # LR tests accounting for imputation
```
